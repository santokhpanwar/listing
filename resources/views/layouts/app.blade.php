...
<head>
    ...
    <link rel="icon" href="{{ url('images/fav-icon.png') }}">
    ...
    <!-- Scripts/ CSS -->
    @vite(['resources/sass/app.scss', 'resources/assets/css/style.css', 'resources/js/app.js','resources/assets/slick/slick.min.js'])
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm sticky-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <img height="50" src="{{url('/images/business_buzzer_logo.png')}}" alt="Business Buzzer">
                </a>
