                    ...
                    <div class="border pt-0 add-listing-form">
                                <div class="control-group form-group">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <textarea id="mytextareaadmin" class="form-control" name="example-textarea-input" rows="6" placeholder="Description"></textarea> 
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="select-category-admin" class="form-control" multiple="multiple">
                                    ...
                                    <select id="days-multiple-admin" class="form-control " multiple="multiple">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select id="opening-time-admin" class="form-control ">
