    ...
    <div class="row justify-content-center">
        <div class="col-md-12 add-new">
            <form action="/admin/listings" method="post">
                @csrf  
                <div class="mb-3"><span class="h4">Add New </span> <span> Add New Business</span></div>
                    <div class=" ">
                    <div class="card mb-3">
                        ...
                        <div class="card-body bg-white">
                            ...
                            <form action="/admin/listings" method="post">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('category') ? 'has-error' : '' }}">
                                            ...
                                            <select id="" name="category[]" class="form-control form-control-lg select" multiple="multiple">
                                ...
                                <div class="form-group mb-3 {{ $errors->has('weekday') ? 'has-error' : '' }}">
                                    ...
                                    <select id="days-multiple-admin" name="weekday[]" class="form-control form-control-lg " multiple="multiple">
                                ...
                                <div class="row ">
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3 {{ $errors->has('opening_time') ? 'has-error' : '' }}">
                                            ...
                                            <select id="opening-time-admin" name="opening_time" class="form-control form-control-lg ">
                                    ...
                                    <div class="card-body p-3 bg-white rounded">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2 {{ $errors->has('iso_certified') ? 'has-error' : '' }}">
                                                <div class="form-group mb-3">
                                                    <select class="form-control form-control-lg" name="iso_certified">
