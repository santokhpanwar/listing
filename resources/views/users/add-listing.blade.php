                        ...
                        <div class="card-body bg-white">
                            ...
                            <form action="/admin/listings" method="post">
                                ...
                                <div class="form-group mb-3 {{ $errors->has('body') ? 'has-error' : '' }}"> 
                                    ...
                                    <textarea id="mytextarea" class="form-control form-control-lg" name="body" rows="10" placeholder="Description"></textarea> 
                                    @if($errors->has('body'))
                                    <p class="help-block text-danger mb-0 p-2">
                                        {{ $errors->first('body') }}
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('category') ? 'has-error' : '' }}">
                                            ...
                                            <select id="select-category" name="category[]" class="form-control form-control-lg select" multiple="multiple">
